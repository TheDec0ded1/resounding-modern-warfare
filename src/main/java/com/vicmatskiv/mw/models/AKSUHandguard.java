...
public class AKSUHandguard extends ModelWithAttachments {
	...
	public custom_model() {
		...
		gun171.cubeList.add(new ModelBox(gun171, 100, 94, 0.002F, 0.0F, -4.0F, 5, 1, 10, 0.0F, false));
		...
		gun169.cubeList.add(new ModelBox(gun169, 102, 93, 0.0F, 0.0F, -4.0F, 5, 1, 10, 0.0F, false));
